				...
				<div class="col-md-6">
				 <div class="login-title">
					...
					<div id="loginbox" class="loginbox">
						<form action="AdminLogin" method="post" name="login" id="login-form">
						  <fieldset class="input">
						    <p id="login-form-username">
						      <label for="modlgn_username">Email</label>
						      <input id="uid" type="text" name="uid" class="inputbox" size="18" autocomplete="off">
						    </p>
						    <p id="pass">
						      <label for="modlgn_passwd">Password</label>
						      <input id="pwd" type="password" name="pwd" class="inputbox" size="18" autocomplete="off">
						    </p>
						    <div class="remember">
